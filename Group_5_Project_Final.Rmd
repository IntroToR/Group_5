...
```{r eval = FALSE, dpi=200, fig.height = 6.5, fig.width = 4.7}
ggplot(potato_entities, aes(x=reorder(Entity, max_yield), y=max_yield)) +
  ...
  labs(x = "Country", y = "Historical Average Yield (tonnes per hectare)")
```
![Grace Tan](/Users/grace/Documents/Grad School Yr 1/R/CPSC_441_personal/Group_5/Figures/Grace_hist_avg_potato.pdf)
